            ...
            <Card className="card-profile shadow rounded-card">
                ...
                <CardBody className="pt-0 pt-md-4">
                  ...
                  <Row className="d-flex align-items-center justify-content-center">
                    ...
                    <Progress
                      max="100"
                      value={porcentaje_victorias(anotherUser.ppganadas, anotherUser.pperdidas)}
                      style={{width: "15vw"}}
                      className="mb-0"
                      barClassName={Math.round(porcentaje_victorias(anotherUser.ppganadas, anotherUser.pperdidas)) < 10 ? "percent10" :
                                    Math.round(porcentaje_victorias(anotherUser.ppganadas, anotherUser.pperdidas)) < 30 ? "percent30" :
                                    Math.round(porcentaje_victorias(anotherUser.ppganadas, anotherUser.pperdidas)) < 50 ? "percent50" :
                                    Math.round(porcentaje_victorias(anotherUser.ppganadas, anotherUser.pperdidas)) < 70 ? "percent70" :
                                    Math.round(porcentaje_victorias(anotherUser.ppganadas, anotherUser.pperdidas)) < 90 ? "percent90" : "percent100"}
                    />
                  </Row>
                </CardBody>
              </Card>
