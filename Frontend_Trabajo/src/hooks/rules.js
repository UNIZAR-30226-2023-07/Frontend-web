...
<div className="d-flex flex-column px-7 text-white">
    ...
    <h2 className="text-justify inicio-reglas-titulo white-text">
    Resumen
    </h2>

    <h3 className="text-justify inicio-reglas-cuerpo white-text">
    ...
    <h3 className="text-justify inicio-reglas-cuerpo white-text pl-5">
